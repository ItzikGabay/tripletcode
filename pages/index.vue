...
<div>
    ...
    <div class="grid place-items-center h-screen-sm">
      ...
      <input type="text" placeholder="Snippet Name" class="input input-primary input-bordered mb-6">
      <prism-editor class="my-editor shadow-2xl rounded max-w-screen-sm" v-model="code" :highlight="highlighter" />
    <ShareOption class="mt-6"/>
    <button class="btn btn-primary mt-6 mb-4" @click="retriveSnippetsList">Share Code</button> 
    </div>
    <Stats/>
